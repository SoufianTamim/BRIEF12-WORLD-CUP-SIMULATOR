...
<html lang="en">
  ...
  <body>
      ...
      <section>
        <?php
          $Table = ["morocco" => ["points" => $ptsM = 0,"games_played" => $playedM = 0,"games_won" => $wonM = 0,"games_equal" => $equalM = 0,"games_lose" => $loseM = 0, "goals_scored" => $scoredM = 0,"goals_received" => $receivedM = 0 , "difference" => $differenceM = 0],
           ...
           $matches = [ "MOROCCO_VS_IRAN" => ["MOROCCO" => 0,"IRAN" => 0,"STATUS" => false], "POTUGUAL_VS_SPAIN" => ["PORTUGUAL" => 0,"SPAIN" => 0,"STATUS" => false],
          ...
          <div class="d-flex align-items-center justify-content-center bg-info  p-2 m-2 rounded">
            <div class="d-flex flex-column">
              <div class="d-flex flex-row align-items-center justify-content-center">
                ...
                <div class="d-flex flex-row align-items-center justify-content-center p-3 m-3 rounded w-50 bg-secondary">
                  <input type="number" class="form-control mx-4 w-25" name="matchName" value="3" min="0" />
                  <span>VS</span>
                  <input type="number" class="form-control mx-3 w-25" name="matchName" value="2" min="0" readonly="readonly" />
                </div>
                <div class="d-flex flex-row">
                  <p><?php $xkey ?>morocco</p>
                </div>
                <div class="m-3">
    ...
    function buildTable(){
      ...
      <div class="">
        <button class="btn btn-outline-success">Simulate</button>
      </div>
      </section>
    </section>
